                ...
                <div className="w-full p-2 justify-start flex flex-col">
                  <form>
                    ...
                    <div className="flex flex-row">
                      <span className="z-highest rounded-l-md w-10 h-10 flex justify-center items-center text-2xl text-gray-400 border border-primary border-r-0" mode="render" block="">
                      ...
                      <input onChange={e => setUsername(e.target.value)} value={username} className="border border-primary rounded-r-md outline-none focus:ring-1 ring-blue-400 w-full pl-1" name="" required={false} placeholder="username"/>
                    </div>
                    <div className="my-4 flex flex-row">
                      <span className="z-highest rounded-l-md w-10 h-10 flex justify-center items-center text-2xl text-primary border border-primary border-r-0" mode="render" block="">
                      ...
                      <input onChange={e => setPassword(e.target.value)} type="password" value={password} className="h-10 border border-primary rounded-r-md outline-none focus:ring-1 ring-blue-300 w-full pl-1" name="" placeholder="password" required={false}/>
                    </div>
                    <button onClick={(e) => login(e)} disabled={formDisabled} value="button" className="px-4 py-2 rounded bg-blue text-white my-4 w-full disabled:bg-grey">Login</button>
                  </form>
                </div>
