    ...
    <div className="relative w-88 sm:w-full max-w-101 rounded my-6 min-h-50 shadow-lg mx-auto bg-white">
      ...
      {/* <div className="flex w-full rounded-b">
            ...
            <div className="w-1/3 flex items-center justify-center">
              <button className="rounded-full inline-flex text-center py-2 px-1 items-center bg-blue w-8 h-8 p-0 my-2 circle-shadow">
            ...
            <div className="w-1/3 flex items-center justify-center">
              <button className="rounded-full inline-flex text-center py-1 px-2 items-center bg-green w-8 h-8 p-0 my-2 circle-shadow">
